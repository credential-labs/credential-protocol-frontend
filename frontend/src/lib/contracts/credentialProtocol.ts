...
export async function issueCredential(
  ...
  const contract = new Contract(import.meta.env.VITE_CREDENTIAL_PROTOCOL_CONTRACT_ID);
...
const CONTRACT_ID = import.meta.env.VITE_CREDENTIAL_PROTOCOL_CONTRACT_ID;
