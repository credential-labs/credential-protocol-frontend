...
const FAQ_ITEMS: FAQItem[] = [
  {
    id: 'what-is-quorum',
    question: 'What is CredentialProtocol?',
    answer: 'CredentialProtocol is a decentralized professional credential verification platform built on Stellar Soroban. It allows engineers to create portable, tamper-proof credentials verified by a personal trust network (quorum slice) of universities, licensing bodies, and employers.',
    category: 'General',
  },
  {
  ...
  },
  {
    ...
    answer: 'CredentialProtocol is privacy-first. You control what information is revealed and to whom. Credentials are stored on-chain but you decide what metadata to include.',
    category: 'Security',
  },
  {
  ...
  },
  {
    ...
    answer: 'CredentialProtocol supports Stellar testnet, mainnet, and futurenet. You can switch networks in your wallet settings.',
    category: 'General',
  },
];
    ...
    <>
      ...
      <main className="container help-main">
        <header className="help-header">
          ...
          <p className="help-subtitle">Find answers to common questions about CredentialProtocol</p>
        </header>
        ...
        <section className="help-section">
          ...
          <div className="help-resources">
            <div className="help-resource-card">
              ...
              <a href="https://github.com/credential-labs/credential-protocol/tree/main/docs" target="_blank" rel="noopener" className="btn btn--ghost btn--sm">
                View Docs
              </a>
            </div>
            ...
            <div className="help-resource-card">
              ...
              <a href="https://github.com/credential-labs/credential-protocol/discussions" target="_blank" rel="noopener" className="btn btn--ghost btn--sm">
                Join Community
              </a>
            </div>
            ...
            <div className="help-resource-card">
              ...
              <a href="https://github.com/credential-labs/credential-protocol/issues" target="_blank" rel="noopener" className="btn btn--ghost btn--sm">
                Report Bug
              </a>
            </div>
          </div>
      ...
      <footer className="footer">
        <div className="container">
          ...
          ·{' '}
          <a href="https://github.com/credential-labs/credential-protocol" target="_blank" rel="noopener">
            CredentialProtocol
          </a>
        </div>
      </footer>
